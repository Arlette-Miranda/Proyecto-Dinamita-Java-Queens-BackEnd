...
INSERT INTO`privileges` (`privilege`,`description`) VALUES
...
INSERT INTO`users` (`name`, `last_name`, `phone`, `email`, `password`, `fk_id_privilege`, active) VALUES
('Carlos', 'Mendoza Ruíz', 5551234567, 'carlos.mendoza@example.com', 'password1', 1,1),
('Laura', 'Gómez Pérez', 5552345678, 'laura.gomez@example.com', 'password2', 2,1),
('Sofia', 'Martínez Pineda', 5553456789, 'sofia.martinez@example.com', 'password3', 3, 1),
('Jorge', 'Ramírez Sánchez', 5554567890, 'jorge.ramirez@example.com', 'password4', 4, 1),
('Ana', 'Cruz Atienza', 5555678901, 'ana.cruz@example.com', 'password5', 2, 1),
('Juan Roberto', 'Fernández Rodríguez', 5556789012, 'roberto.fernandez@example.com', 'password6', 2, 1),
('María', 'Gonzalez López', 5567852618, 'maria.gonzalez@example.com', 'password7', 5, 1);

-- Inserciones adicionales para la tabla `yoatzin`.`cards`
INSERT INTO `cards` (`number`, `owner_card`, `month`, `year`, `cvc`,`fk_id_user`) VALUES
...
INSERT INTO`addresses` (`state`, `city`, `colony`, `street`, `zipcode`, `reference`,`fk_id_user`) VALUES
...
INSERT INTO`orders` (`quantity`, `date`, `fk_id_user`, `fk_id_card`, `fk_id_address`) VALUES
...
INSERT INTO`products` (`name`, `category`, `price`, `image`, `origin`, `stock`, `description`, `fk_id_size`) VALUES
...
INSERT INTO `comments` (`comment`, `fk_id_user`) VALUES
...
INSERT INTO `products_has_orders` (`product_id`, `order_id`, `partial_amount`,`discount`, `shipment`, `final_amount`) VALUES
