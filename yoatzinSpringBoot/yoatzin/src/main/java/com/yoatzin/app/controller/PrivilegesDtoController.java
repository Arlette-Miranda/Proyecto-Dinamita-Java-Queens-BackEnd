...
import com.yoatzin.app.service.PrivilegesDtoService;
import com.yoatzin.app.service.UserDtoService;

@RestController
@RequestMapping("api/v2/users")
@CrossOrigin(origins = "*")
public class PrivilegesDtoController {

	PrivilegesDtoService privilegesDtoService;

	public PrivilegesDtoController(PrivilegesDtoService privilegesDtoService) {
		this.privilegesDtoService = privilegesDtoService;
	}

	@PostMapping
	ResponseEntity<PrivilegesDto> createPrivileges(@RequestBody Privileges user) {
